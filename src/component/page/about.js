                ...
                <section>
                    ...
                    <div className="l-contents_area about c-contents_area">
                        ...
                        <div>
                            ...
                            <p className="about_description">フロントエンドの開発を担当。サイトリニューアルやLP制作、ページ速度改善などを行う。また、SEO開発担当としてクローラビリティの改善、構造化データの設定、MFI対応などを行い、サイト流入数を昨対比120%まで増加させた。さらに、年に４回行われる自社イベントをシステム化をするプロジェクトでフロントエンドの開発を担当し、開発工数を30人日から3人日までに削減した。</p>
                        </div>
                    </div>
